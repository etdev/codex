...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("vim_normal", "Vim normal", "repeat_find", "Repeat the last character find."),
    action("vim_normal", "Vim normal", "repeat_find_reverse", "Repeat the last character find in the opposite direction."),
    ...
    action("vim_normal", "Vim normal", "join_lines", "Join the current line with the next line."),
    action("vim_normal", "Vim normal", "indent_lines", "Indent the current line; press twice."),
    action("vim_normal", "Vim normal", "dedent_lines", "Dedent the current line; press twice."),
    ...
    action("vim_operator", "Vim operator", "motion_first_non_blank", "Operator motion to the first non-blank character."),
    ...
    action("vim_operator", "Vim operator", "motion_repeat_find", "Repeat the last character find as an operator motion."),
    action("vim_operator", "Vim operator", "motion_repeat_find_reverse", "Repeat the last character find in reverse as an operator motion."),
