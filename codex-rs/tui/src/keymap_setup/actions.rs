...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("vim_normal", "Vim normal", "move_big_word_forward", "Move to the start of the next WORD."),
    action("vim_normal", "Vim normal", "move_big_word_backward", "Move to the start of the previous WORD."),
    action("vim_normal", "Vim normal", "move_big_word_end", "Move to the end of the current or next WORD."),
    action("vim_normal", "Vim normal", "move_line_start", "Move to the start of the line."),
    action("vim_normal", "Vim normal", "move_first_non_blank", "Move to the first non-blank character of the line."),
    action("vim_normal", "Vim normal", "move_line_end", "Move to the end of the line."),
    action("vim_normal", "Vim normal", "move_buffer_start", "Press twice to move to the first non-blank character of the buffer."),
    action("vim_normal", "Vim normal", "move_buffer_end", "Move to the first non-blank character of the last line."),
    action("vim_normal", "Vim normal", "undo", "Undo the most recent Vim edit."),
    action("vim_normal", "Vim normal", "repeat_change", "Repeat the most recent Vim edit."),
    ...
    action("vim_normal", "Vim normal", "paste_before", "Paste before the cursor."),
    action("vim_normal", "Vim normal", "join_lines", "Join the current line with following lines."),
    action("vim_normal", "Vim normal", "indent_lines", "Press twice to indent one or more lines."),
    action("vim_normal", "Vim normal", "dedent_lines", "Press twice to dedent one or more lines."),
    action("vim_normal", "Vim normal", "find_forward", "Find a character forward on the current line."),
    action("vim_normal", "Vim normal", "find_backward", "Find a character backward on the current line."),
    action("vim_normal", "Vim normal", "till_forward", "Move until before a character on the current line."),
    action("vim_normal", "Vim normal", "till_backward", "Move until after a character on the current line."),
    action("vim_normal", "Vim normal", "repeat_find", "Repeat the most recent character find."),
    action("vim_normal", "Vim normal", "repeat_find_reverse", "Repeat the most recent character find in reverse."),
    ...
    action("vim_operator", "Vim operator", "motion_big_word_forward", "Operator motion to start of next WORD."),
    action("vim_operator", "Vim operator", "motion_big_word_backward", "Operator motion to start of previous WORD."),
    action("vim_operator", "Vim operator", "motion_big_word_end", "Operator motion to end of WORD."),
    action("vim_operator", "Vim operator", "motion_line_start", "Operator motion to line start."),
    action("vim_operator", "Vim operator", "motion_first_non_blank", "Operator motion to first non-blank character."),
    action("vim_operator", "Vim operator", "motion_line_end", "Operator motion to line end."),
    action("vim_operator", "Vim operator", "motion_buffer_start", "Operator motion to the first buffer line; press twice."),
    action("vim_operator", "Vim operator", "motion_buffer_end", "Operator motion to the last buffer line."),
    action("vim_operator", "Vim operator", "motion_find_forward", "Operator find motion forward."),
    action("vim_operator", "Vim operator", "motion_find_backward", "Operator find motion backward."),
    action("vim_operator", "Vim operator", "motion_till_forward", "Operator till motion forward."),
    action("vim_operator", "Vim operator", "motion_till_backward", "Operator till motion backward."),
    action("vim_operator", "Vim operator", "motion_repeat_find", "Repeat the last find as an operator motion."),
    action("vim_operator", "Vim operator", "motion_repeat_find_reverse", "Repeat the last find in reverse as an operator motion."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("vim_normal", "move_big_word_forward") => Some(&mut keymap.vim_normal.move_big_word_forward),
        ("vim_normal", "move_big_word_backward") => Some(&mut keymap.vim_normal.move_big_word_backward),
        ("vim_normal", "move_big_word_end") => Some(&mut keymap.vim_normal.move_big_word_end),
        ("vim_normal", "move_line_start") => Some(&mut keymap.vim_normal.move_line_start),
        ("vim_normal", "move_first_non_blank") => Some(&mut keymap.vim_normal.move_first_non_blank),
        ("vim_normal", "move_line_end") => Some(&mut keymap.vim_normal.move_line_end),
        ("vim_normal", "move_buffer_start") => Some(&mut keymap.vim_normal.move_buffer_start),
        ("vim_normal", "move_buffer_end") => Some(&mut keymap.vim_normal.move_buffer_end),
        ...
        ("vim_normal", "paste_before") => Some(&mut keymap.vim_normal.paste_before),
        ("vim_normal", "join_lines") => Some(&mut keymap.vim_normal.join_lines),
        ("vim_normal", "indent_lines") => Some(&mut keymap.vim_normal.indent_lines),
        ("vim_normal", "dedent_lines") => Some(&mut keymap.vim_normal.dedent_lines),
        ...
        ("vim_operator", "motion_big_word_forward") => Some(&mut keymap.vim_operator.motion_big_word_forward),
        ("vim_operator", "motion_big_word_backward") => Some(&mut keymap.vim_operator.motion_big_word_backward),
        ("vim_operator", "motion_big_word_end") => Some(&mut keymap.vim_operator.motion_big_word_end),
        ("vim_operator", "motion_line_start") => Some(&mut keymap.vim_operator.motion_line_start),
        ("vim_operator", "motion_first_non_blank") => Some(&mut keymap.vim_operator.motion_first_non_blank),
        ("vim_operator", "motion_line_end") => Some(&mut keymap.vim_operator.motion_line_end),
        ("vim_operator", "motion_buffer_start") => Some(&mut keymap.vim_operator.motion_buffer_start),
        ("vim_operator", "motion_buffer_end") => Some(&mut keymap.vim_operator.motion_buffer_end),
        ...
        ("vim_operator", "motion_repeat_find") => Some(&mut keymap.vim_operator.motion_repeat_find),
        ("vim_operator", "motion_repeat_find_reverse") => Some(&mut keymap.vim_operator.motion_repeat_find_reverse),
